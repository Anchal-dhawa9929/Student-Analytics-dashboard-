...
3 page interactive student analytics dashboard using power bi to analyze  student demographics, attendence trends, academic performance and key KPIs using dynamic filters and data visualisations
**Student Analytics Dashboard (Power BI)**

> A comprehensive 3-page interactive Power BI dashboard for analyzing student academic performance, attendance patterns, and overall session-level insights.
...
| Microsoft Excel (.xlsx)-Data source / raw data file 
...
- **Data Includes:**
  - Student ID, Name, Course (BBA / BCA / MCA)
  - Subject, Semester, Session (2024-25, 2025-26)
  - Marks & Percentage, Result Status (Pass / Fail)
  - Attendance Records — Present, Absent, Late counts
  - Gender, Enrollment Status (Active / Inactive)



## 📄 Dashboard Pages

### Page 1 — Academic Performance Dashboard
Focuses on marks and result analysis across students and subjects. Includes subject-wise average marks, course-wise percentage totals, pass/fail distribution, and a detailed student records table.

### Page 2 — Attendance Analytics Dashboard
Tracks daily and subject-wise attendance trends. Shows present, absent, and late breakdowns per student and subject with a 30-day daily trend line.

### Page 3 — Student Analytics Dashboard (All Session)
High-level overview across both academic sessions (2024-25 and 2025-26) with enrollment, demographic, and attendance breakdowns.
